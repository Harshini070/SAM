...
<<<<<<< HEAD
  ...
  userCard: { backgroundColor: Colors.white, borderRadius: 16, padding: 20, alignItems: 'center', shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 1, shadowRadius: 24, elevation: 4, marginBottom: 16, borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  userRole: { fontSize: 12, color: Colors.textSecondary, marginTop: 4, textAlign: 'center', fontWeight: '500' },
  statusRow: { marginTop: 10 },
  statusPill: { backgroundColor: Colors.primary + '0A', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
  ...
  menuCard: { backgroundColor: Colors.white, borderRadius: 14, paddingHorizontal: 14, shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 1, shadowRadius: 24, elevation: 2, borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  menuValue: { fontSize: 12, color: Colors.textSecondary, fontWeight: '500' },
