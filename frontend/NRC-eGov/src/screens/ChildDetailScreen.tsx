...
const styles = StyleSheet.create({
  ...
  loadingText: { ...Typography.bodySmall, color: Colors.textSecondary, marginTop: Spacing.sm, fontWeight: '600' },
  errorTitle: { ...Typography.h3, color: Colors.textPrimary, marginTop: Spacing.md, fontWeight: '800' },
  ...
  card: { backgroundColor: Colors.white, borderRadius: Radius.lg, padding: Spacing.md, shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 1, shadowRadius: 24, elevation: 4, borderWidth: 1, borderColor: '#E5E7EB' },
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, borderBottomWidth: 1, borderBottomColor: '#F3F4F6', paddingBottom: Spacing.md, marginBottom: Spacing.md },
  avatarCircle: { width: 50, height: 50, borderRadius: 25, alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontSize: 20, fontWeight: '800' },
  headerMeta: { flex: 1 },
  childName: { ...Typography.h3, color: Colors.textPrimary, fontWeight: '800' },
  childGenderAge: { ...Typography.bodySmall, color: Colors.textSecondary, marginTop: 2, fontWeight: '500' },
  ...
  gridLabel: { ...Typography.caption, color: Colors.textMuted, fontWeight: '600' },
  gridVal: { ...Typography.h4, color: Colors.textPrimary, marginTop: Spacing.xs - 2, fontWeight: '700' },
  referralBanner: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, backgroundColor: Colors.error, borderRadius: Radius.lg, padding: Spacing.md, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', shadowColor: Colors.error, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.15, shadowRadius: 10, elevation: 4 },
  referralTextContainer: { flex: 1 },
  referralTitle: { ...Typography.h4, color: Colors.white, fontWeight: '800' },
  ...
  nrcSubText: { ...Typography.bodySmall, color: Colors.textSecondary, paddingLeft: 22, fontWeight: '500' },
  sectionHeader: { ...Typography.h4, color: Colors.primary, marginBottom: Spacing.sm, fontWeight: '700' },
  chart: { borderRadius: Radius.md, marginLeft: -Spacing.xs },
  metaRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: Spacing.sm, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
  metaLabel: { ...Typography.bodySmall, color: Colors.textSecondary, fontWeight: '500' },
  ...
  recText: { ...Typography.bodySmall, color: Colors.textPrimary, flex: 1, lineHeight: 18, fontWeight: '500' },
  logRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: Spacing.sm },
  logBorder: { borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
  logDate: { ...Typography.bodySmall, color: Colors.textSecondary, flex: 1, fontWeight: '500' },
  logMeta: { flexDirection: 'row', gap: Spacing.sm, flex: 2 },
  logStat: { fontSize: 11, color: Colors.textPrimary, fontWeight: '600' },
  logBadge: { borderRadius: Radius.full, paddingHorizontal: Spacing.sm, paddingVertical: 2 },
  logBadgeText: { fontSize: 9, fontWeight: '800' },
});
