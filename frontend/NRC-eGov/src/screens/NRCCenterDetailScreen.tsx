...
const styles = StyleSheet.create({
  ...
  errorTitle: { ...Typography.h3, color: Colors.textPrimary, fontWeight: '800' },
  ...
  bedTextCol: { flex: 1 },
  bedTitle: { ...Typography.h4, color: Colors.textPrimary, fontWeight: '800' },
  bedSubtitle: { fontSize: 11, color: Colors.textSecondary, marginTop: 1, fontWeight: '500' },
  percentBlock: { alignItems: 'flex-end' },
  percentText: { fontSize: 20, fontWeight: '800' },
  percentSub: { fontSize: 9, color: Colors.textMuted, fontWeight: '700' },
  bedProgressTrack: { height: 6, backgroundColor: '#E5E7EB', borderRadius: 3, overflow: 'hidden', marginBottom: Spacing.md },
  bedProgressFill: { height: '100%', borderRadius: 3 },
  bedStatsGrid: { flexDirection: 'row', borderTopWidth: 1, borderTopColor: '#F3F4F6', paddingTop: Spacing.md },
  bedStatCol: { flex: 1, alignItems: 'center' },
  bedStatVal: { ...Typography.h3, color: Colors.textPrimary, fontWeight: '800' },
  bedStatLbl: { ...Typography.caption, color: Colors.textMuted, marginTop: 2, fontWeight: '600' },
  actionsRow: { flexDirection: 'row', gap: Spacing.md },
  actionButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.xs, backgroundColor: Colors.white, borderRadius: Radius.lg, paddingVertical: Spacing.md, borderWidth: 1, borderColor: '#E5E7EB', shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 1, shadowRadius: 12, elevation: 2 },
  actionBtnText: { ...Typography.caption, color: Colors.primary, fontWeight: '700' },
  sectionHeader: { ...Typography.h4, color: Colors.primary, marginBottom: Spacing.md, fontWeight: '700' },
  specificationRow: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.sm, marginBottom: Spacing.md },
  specIcon: { marginTop: 2 },
  specContent: { flex: 1 },
  specLabel: { ...Typography.caption, color: Colors.textMuted, fontWeight: '700' },
  specValue: { ...Typography.bodySmall, color: Colors.textPrimary, marginTop: 2, lineHeight: 18, fontWeight: '500' },
  emptyPatients: { alignItems: 'center', justifyContent: 'center', paddingVertical: Spacing.lg, gap: Spacing.xs },
  emptyPatientsText: { fontSize: 11, color: Colors.textMuted, textAlign: 'center', fontWeight: '500' },
  patientRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, paddingVertical: Spacing.sm, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
  patientMeta: { flex: 1 },
  patientName: { ...Typography.label, color: Colors.textPrimary, fontWeight: '700' },
  patientId: { fontSize: 11, color: Colors.textSecondary, marginTop: 1, fontWeight: '500' },
